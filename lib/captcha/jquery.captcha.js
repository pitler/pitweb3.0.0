;(function( $ ){
	...
	var defaults = {  
	   borderColor: "",  
	   captchaDir: "src/lib/captcha",  
	   url: "src/lib/captcha/captcha.php",  
	   formId: "loginForm",  
	   text: "Arrastra <span>lupa</span> al círculo.",
	   items: Array("lupa", "pluma", "reloj", "diskete", "llave") 
	  };	
	...
	//alert("<img src=\"" + options.captchaDir +"/imgs/item-" + options.items[pic] + ".png\" alt=\"\" />");
	...
	for(var i=0;i<5;i++){
		...
		if(i != rand && i != pic)	
		{
			...
			//alert("<img src=\"" + options.captchaDir +"/imgs/item-" + options.items[i] + ".png\" alt=\"\" />");
		}
	}
