	...
	$.HSCore.components.HSFileAttachment = {
		...
		_baseConfig: {
			changeInput: '<div class="u-file-attach-v3 g-mb-15">\
               				<h3 class="g-font-size-16 g-color-gray-dark-v2 mb-0">Arrastra tus archivos o <span class="g-color-primary">Busca en tu equipo</span></h3>\
               				<p class="g-font-size-14 g-color-gray-light-v2 mb-0">Tamaño maximo del archivo 10mb</p>\
              			</div>',
			showThumbs: true,
			templates: {
			...
			uploadFile: {
				url: 'pw/assets2/include/php/file-upload/upload.php',
				data: {},
				type: 'POST',
