...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            button: "Selecciona archivos",
            feedback: "Selecciona archivos a cargar",
            feedback2: "archivos fueron seleccionados",
            drop: "Arrastra aquí para cargar",
            removeConfirmation: "Seguro que quieres eliminar el archivo?",
            errors: {
                filesLimit: "Solo {{fi-limit}} archivos permitidos.",
                filesType: "Solo se periten imagenes.",
                filesSize: "{{fi-name}} es muy grande! Máximo tamaño de archivo {{fi-fileMaxSize}} MB.",
                filesSizeAll: "Los archivos que seleccionaste son muy pesados! Máximo permitodo por archivo {{fi-maxSize}} MB.",
                folderUpload: "No está permitido cargar carpetas."
            }
        }
    }
})(jQuery);
